...
void setHDMITX_HBRAudio(u8 bAudInterface /*I2S/SPDIF/TDM*/)
{
    ...
    it6161_hdmi_tx_set_bits(it6161, 0x5c, BIT6, 0x00);
...
static int hdmi_tx_get_avi_infoframe_from_user_define(struct it6161 *it6161, u8 *buffer, size_t size)
{
	...
	ret = drm_hdmi_avi_infoframe_from_display_mode(frame, display_mode, false);
	if (ret) {
...
void mipi_rx_prec_get_display_mode( void )
{
